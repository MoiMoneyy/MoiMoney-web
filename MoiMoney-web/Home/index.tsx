...
import naverLogo from '../src/assets/naver-logo.svg';
import kakaoLogo from '../src/assets/kakao-logo.svg';
...
const IndexPage = () => {
	...
	useEffect(() => {
		const saved = localStorage.getItem('recentLoginProvider') as Provider | null;
			...
			<div style={styles.mainDisplay}>
				...
				<div style={styles.loginButtons}>
					<div style={styles.socialBtnWrapper}>
						{recentProvider === 'naver' && <div style={styles.recentBadge}>최근 로그인</div>}
						<span
					...
					<div style={styles.socialBtnWrapper}>
						{recentProvider === 'kakao' && <div style={styles.recentBadge}>최근 로그인</div>}
						<span
